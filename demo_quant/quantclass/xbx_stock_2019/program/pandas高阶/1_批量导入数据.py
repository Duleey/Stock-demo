...
df = pd.read_csv(
    r'/demo_quant/quantclass/xbx_stock_2019/data/basic-trading-data/stock_data/sh600004.csv',
    encoding='gbk',
...
file_location = r'/demo_quant/quantclass/xbx_stock_2019/data/basic-trading-data/stock_data'
...
all_data = pd.read_hdf(
    r'/demo_quant/quantclass/xbx_stock_2019/store/a_stock.h5',
    key='all_data')
print(all_data)
