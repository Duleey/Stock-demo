...
# =====导入数据
df = pd.read_csv(
    r'/demo_quant/quantclass/xbx_stock_2019/data/a_stock_201903.csv',
    encoding='gbk',
)
...
# 0.创建缺失值
# print(df)
index = df[df['交易日期'].isin(['2019-03-01', '2019-03-10', '2019-03-15'])].index
# print(index)
...
# 2.补全缺失值
# print(df.fillna(value='ye'))  # 直接将缺失值赋值为固定的值
