...
# =====读入股票数据
stock_code = 'sz000002'
df = pd.read_csv('/Users/lvjianwei/Desktop/workspace/Stock-demo/demo/quantclass/xbx_stock_2019-pro/xbx_stock_2019/data/择时策略-回测/%s.csv' % stock_code,
...
# =====将数据存入hdf文件中
df.to_hdf('/Users/lvjianwei/Desktop/workspace/Stock-demo/demo/quantclass/xbx_stock_2019-pro/xbx_stock_2019/data/择时策略-回测/signals.h5', key='df', mode='w')
