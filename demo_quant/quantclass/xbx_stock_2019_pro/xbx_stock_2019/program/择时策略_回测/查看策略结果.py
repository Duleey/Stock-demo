...
from demo_quant.quantclass.xbx_stock_2019_pro.xbx_stock_2019.program.择时策略_回测.Signals import simple_moving_average_signal
...
# 读入股票数据
stock_code = 'sz000002'
df = pd.read_csv('/Users/lvjianwei/Desktop/workspace/Stock-demo/demo_quant/quantclass/xbx_stock_2019_pro/xbx_stock_2019/data/择时策略-回测/%s.csv' % stock_code, encoding='gbk', skiprows=1, parse_dates=['交易日期'])
