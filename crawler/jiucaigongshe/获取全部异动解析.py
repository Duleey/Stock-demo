...
for v in res.json()['data']:
    if 'list' in v:
        ...
        for l in v['list']:
            ...
            csv_to_png(csv_path=f'../../CSV/jiucaigongshe/ydjx/{title_check}{date}.md', title_name=title_check, date=date)
...
csv_to_png(csv_path=csv_path, title_name="all", date=date)
