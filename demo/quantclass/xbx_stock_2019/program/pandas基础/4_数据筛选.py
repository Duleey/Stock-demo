...
df = pd.read_csv(
    ...
    filepath_or_buffer=r'/Users/lvjianwei/Desktop/workspace/Stock-demo/demo/quantclass/xbx_stock_2019/data/a_stock_201903.csv',
...
# print(df[df['股票代码'] == 'sz000001'].index)  # 输出判断为True的行的index
...
print(df[(df['收盘价'] < 100.0) & (df['交易日期'] == '2019-03-20')])  # 两个条件，或者的话就是|