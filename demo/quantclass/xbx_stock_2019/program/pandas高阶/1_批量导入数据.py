...
df = pd.read_csv(
    r'/Users/lvjianwei/Desktop/workspace/Stock-demo/demo/quantclass/xbx_stock_2019/data/basic-trading-data/stock_data/sh600004.csv',
    encoding='gbk',
...
# 将数据存入hdf文件中
all_data.to_hdf(
    r'/Users/lvjianwei/Desktop/workspace/Stock-demo/demo/quantclass/xbx_stock_2019/store/a_stock.h5',
    key='all_data',
    mode='w'
)
